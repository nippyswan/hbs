@extends('layouts.app')
@section('content')
@if(Session::has('revadd'))<div class="alert alert-success">{{Session::get('revadd')}}</div>@endif
@auth
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/custReview" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" id="base64" name="base64">                        
                        <div class="form-group row">
                            <div class="col-md-3 text-md-right">
                                <label for="image">Image (667:375 ratio)</label>
                            </div>
                            <div class="col-md-4">
